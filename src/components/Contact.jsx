    ...
    <SectionWrapper id="contact" className="bg-[#EBE1D1] overflow-hidden !py-0 !lg:py-0 my-0">
      <div className="mx-auto max-w-7xl px-4 md:px-6">
        ...
        <div className="grid md:grid-cols-3 gap-0 border border-[#41644A]/20 rounded-xl md:rounded-[2rem] overflow-hidden shadow-sm mb-6 bg-white/30 backdrop-blur-sm">
          ...
          <Box icon={MapPin} title="Office" description="Our headquarters in Bangalore.">
          ...
          <Box icon={Phone} title="Phone" description="Mon-Sat, 9am-7pm." className="md:border-r-0">
...
function Box({ icon: Icon, title, description, className = "", children }) {
  return (
    <div className={`flex flex-col border-b md:border-r md:border-b-0 border-[#41644A]/20 ${className}`}>
